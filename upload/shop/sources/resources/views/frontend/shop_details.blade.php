...
<form class="row" action="{{ route('inventory.order') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-lg-7 col-md-7">
        ...
        <div class="reportForm">
            ...
            <input type="hidden" name="listing_creator_id" value="{{ $creator->user_id }}">
            <input type="hidden" name="amount" id="total_amount">

            <div class="mb-2">
                <input type="text" class="form-control ua-form-control" name="customer_name" placeholder="{{ get_phrase('Full Name') }}" required>
            </div>
            <div class="mb-2">
                <input type="email" class="form-control ua-form-control" name="customer_email" placeholder="{{ get_phrase('Email') }}" required>
            </div>
            <div class="mb-2">
                <input type="number" class="form-control ua-form-control" name="customer_phone" placeholder="{{ get_phrase('Phone Number') }}" required>
            </div>
            <div class="mb-2">
                <input type="text" class="form-control ua-form-control" name="customer_address" placeholder="{{ get_phrase('Address') }}" required>
            </div>
            <div class="mb-2">
            ...
            <div>
                ...
                <span class="titles">{{ get_phrase('Payment Method : Cash on Delivery') }}</span>
            </div>
        </div>
    </div>
</form>
