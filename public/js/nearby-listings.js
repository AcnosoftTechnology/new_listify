    ...
    function applyDistanceTag(card, distance) {
        ...
        if (!tag) {
            ...
            const locationBlock = card.querySelector(
                '.location, .hotellist-title-location .location, .beautylist-location, .beautygrid-location-title .location, .hotelgrid-location-rating .location, .restgrid-price-rating .location, .reals-grid-details .location'
            );
    ...
    class ListingProximityHandler {
        ...
        async handleGeolocationUpdate(latitude, longitude) {
            ...
            try {
                ...
                const pageType = getListingTypeFromUrl() || getListingTypeFromDetailUrl();
                if (pageType) {
