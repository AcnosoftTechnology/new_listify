@php $user_prefix = (user('is_agent') == 1) ? 'agent' : 'customer'; $active = ''; @endphp
                ...
                <nav>
                    <ul>
                        ...
                        <li class="sidebar-nav-item"><a href="{{ route('user.messages', ['prefix' => $user_prefix]) }}" class="sidebar-nav-link {{ $active == 'message' ? 'active' : '' }}">
                                ...
                                @php $unreadMessages = unread_message_count(); @endphp
                                @if($unreadMessages > 0)
                                    <span class="badge-secondary mt-1px">{{ $unreadMessages }}</span>
                                @endif
                            </a></li>
                        <li class="sidebar-nav-item"><a href="{{ route('customer.invoice') }}" class="sidebar-nav-link {{ $active == 'invoice' ? 'active' : '' }}">
                                <span class="d-flex align-items-start mt-1px gap-6px">
       <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span class="mt-1px">{{ get_phrase('Invoice Policy') }}</span>
                                </span>
                            </a></li>
            ...
            @if (check_subscription(user('id')))
                ...
                <!-- abhishek-editing--->
                   ...
                   <li class="sidebar-nav-item mt-2">
                     <a href="{{route('customer.qrcode')}}" class="sidebar-nav-link {{ $active == 'qrcode' ? 'active' : '' }}">
                         <span class="d-flex align-items-start mt-1px gap-6px">
                            <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" aria-label="barcode icon">
                              <rect width="18" height="18" fill="none"/>
                              <!-- bars -->
                              <rect x="1"  y="2" width="1" height="14" fill="#99A1B7"/>
                              <rect x="3"  y="2" width="0.5" height="14" fill="#99A1B7"/>
                              <rect x="4.5" y="2" width="1.2" height="14" fill="#99A1B7"/>
                              <rect x="7"  y="2" width="0.6" height="14" fill="#99A1B7"/>
                              <rect x="8.2" y="2" width="1.8" height="14" fill="#99A1B7"/>
                              <rect x="10.5" y="2" width="0.5" height="14" fill="#99A1B7"/>
                              <rect x="12" y="2" width="1.4" height="14" fill="#99A1B7"/>
                              <rect x="14" y="2" width="0.7" height="14" fill="#99A1B7"/>
                              <rect x="15.2" y="2" width="1.2" height="14" fill="#99A1B7"/>
                           </svg>

                            <span class="mt-1px">{{ get_phrase('Qrcode') }}</span>
                          </span>
                     </a>
                   </li>       
                   ...
                   <li class="sidebar-nav-item mt-2"><a href="{{route('customer.mycrm')}}" class="sidebar-nav-link {{ $active == 'mycrm' ? 'active' : '' }}">
                                <span class="d-flex align-items-start mt-1px gap-6px">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.11992 8.1525C9.04492 8.145 8.95492 8.145 8.87242 8.1525C7.08742 8.0925 5.66992 6.63 5.66992 4.83C5.66992 2.9925 7.15492 1.5 8.99992 1.5C10.8374 1.5 12.3299 2.9925 12.3299 4.83C12.3224 6.63 10.9049 8.0925 9.11992 8.1525Z" stroke="#99A1B7" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M5.37004 10.92C3.55504 12.135 3.55504 14.115 5.37004 15.3225C7.43254 16.7025 10.815 16.7025 12.8775 15.3225C14.6925 14.1075 14.6925 12.1275 12.8775 10.92C10.8225 9.5475 7.44004 9.5475 5.37004 10.92Z" stroke="#99A1B7" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                    <span class="mt-1px">{{ get_phrase('My CRM') }}</span>
                                </span>
                   </a></li>
                      
                      
                    <li class="sidebar-nav-item d-none"><a href="#" class="sidebar-nav-link {{ $active == 'account' ? 'active' : '' }}">
                                <span class="d-flex align-items-start mt-1px gap-6px">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.11992 8.1525C9.04492 8.145 8.95492 8.145 8.87242 8.1525C7.08742 8.0925 5.66992 6.63 5.66992 4.83C5.66992 2.9925 7.15492 1.5 8.99992 1.5C10.8374 1.5 12.3299 2.9925 12.3299 4.83C12.3224 6.63 10.9049 8.0925 9.11992 8.1525Z" stroke="#99A1B7" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M5.37004 10.92C3.55504 12.135 3.55504 14.115 5.37004 15.3225C7.43254 16.7025 10.815 16.7025 12.8775 15.3225C14.6925 14.1075 14.6925 12.1275 12.8775 10.92C10.8225 9.5475 7.44004 9.5475 5.37004 10.92Z" stroke="#99A1B7" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                    <span class="mt-1px">{{ get_phrase('My Shop') }}</span>
                                </span>
                      </a>
                   </li> 
             ...
             @endphp
              ...
              <li class="sidebar-nav-item">
                  <a href="{{ route('customer.notification') }}" class="sidebar-nav-link {{ $active == 'notification' ? 'active' : '' }}">
                      <span class="d-flex align-items-start mt-1px gap-6px">
                          <span class="mt-1px">{{ get_phrase('All Notifications') }}</span>                                   
                      </span>
                      <span class="badge-secondary mt-1px">{{ $notificationCount }}</span>
                  </a>
              </li>
              ...
              @if(!empty(Auth::user()->whatsapp) && should_show_whatsapp())
                  <div class="agent_whatsapp_no mt-2">
                      <a href="https://wa.me/{{ Auth::user()->whatsapp }}" class="btn btn-success w-100 p-2"> 
