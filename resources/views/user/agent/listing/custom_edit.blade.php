                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="possition_relative" id="image-icon{{$key}}">
                                            ...
                                            <a href="javascript:void(0);" onclick="listing_image_delete('{{route('user.listing.image.delete',['type'=>$listing->type,'id'=>$listing->id, 'image'=>base64_encode($image)])}}', '{{$key}}')">
                                               <i class="fas fa-times" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('delete') }}"></i>
                                            </a>
