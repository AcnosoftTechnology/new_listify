 ...
 <section>
    <div class="container">
        ...
        <div class="row row-28 mb-80">
            ...
            @endphp
            @foreach (sort_listings_by_distance($relatedListing) as $listing)
            <!-- Single Card -->
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6" data-listing-id="{{ $listing->id }}" data-listing-type="restaurant">
