    ...
    <section>
        <div class="container">
            ...
            <div class="row row-28 mb-80">
                ...
                @endphp
                <!-- Single Card -->
                @foreach(sort_listings_by_distance($RealEstateListings) as $listings)
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6" data-listing-id="{{ $listings->id }}" data-listing-type="real-estate">
