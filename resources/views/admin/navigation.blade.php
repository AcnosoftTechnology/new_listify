        ...
        <ul class="px-14px pb-24px">
            ...
            <li class="sidebar-first-li first-li-have-sub {{request()->is('admin/system-setting') || request()->is('admin/language-setting') || request()->is('admin/email-settings') || request()->is('admin/website-setting') || request()->is('admin/language-phrase*') || request()->is('admin/payment-edit*') || request()->is('admin/payment-gateways*') || request()->is('admin/live-chat/tawk-settings*') || request()->is('admin/form-builder*') || $current_route == 'admin.seo.settings' || $current_route == 'admin.about' ?'active':''}}">
                ...
                <ul class="first-sub-menu">
                    ...
                    <li class="sidebar-second-li {{request()->is('admin/customlisting-setting')?'active':''}}"><a href="{{ route('admin.Customlisting.settings')}}"> {{get_phrase('Custom Listing Settings')}} </a></li>
          ...
          <!----start-notification-tab--->
            ...
            <li class="sidebar-first-li"><a href="{{ route('admin.notification')}}">
               <span>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 2C10.3431 2 9 3.34315 9 5V6.26505C6.19124 7.15004 4.25 9.82885 4.25 13V17L3 18.25V19H21V18.25L19.75 17V13C19.75 9.82885 17.8088 7.15004 15 6.26505V5C15 3.34315 13.6569 2 12 2Z" stroke="#99A1B7" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path>
                  <path d="M14 21C14 22.1046 13.1046 23 12 23C10.8954 23 10 22.1046 10 21" stroke="#99A1B7" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path>
                  </svg>
              </span>              
                <div class="text">
