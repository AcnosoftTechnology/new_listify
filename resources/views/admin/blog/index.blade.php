        ...
        <table id="datatable" class="table nowrap w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> {{$blog->title}} </td>
                    <td>{{ optional(App\Models\Blog_category::where('id', $blog->category)->first())->name ?? 'N/A' }}</td>
                    <td>
                    ...
                    <td> 
                        <div class="dropdown ol-icon-dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li><a class="dropdown-item fs-14px" onclick="delete_modal('{{route('admin.blog.delete',['id'=>$blog->id])}}')" href="javascript:void(0);"> {{get_phrase('Delete')}} </a></li>
                            </ul>
                        </div>
                    </td>
                </tr>                
