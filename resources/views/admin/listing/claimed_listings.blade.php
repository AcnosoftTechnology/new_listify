    ...
    <tr>
        ...
        <td> 
            <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                <div class="dAdmin_profile_name">
                    <p class="fs-14px mb-1">
                        {{get_phrase('Name')}}: {{$listings->user_name}}
                    </p>

                    <p class="sfs-14px mb-1">
                        {{get_phrase('Phone')}}: {{$listings->user_phone}}
                    </p>

                    <p class="fs-14px">
                        {{$listings->additional_info}}
                    </p>  
                </div>
            </div>
        </td>
        ...
        <td>
            <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                <div class="dAdmin_profile_name">
                    ...
                    <p class="sub-title2 text-12px badge bg-success">
                        {{get_phrase('Approve')}}
                    </p>

                    @else

                    <p class="sub-title2 text-12px badge bg-warning">
                        {{get_phrase('Pending')}}
                    </p>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a class="dropdown-item fs-14px"
                           href="{{route('listing.details',['id'=>$listing->id,'type'=>$listing->type, 'slug'=>$listing->title])}}"
                           target="_blank">
                    ...
                    <li>
                        <a class="dropdown-item fs-14px"
                           onclick="confirm_modal('{{route('admin.claim-listing.approve',['type' => $listings->listing_type, 'listing_id'=>$listings->id])}}')"
                           href="javascript:;">
                    ...
                    <li>
                        <a class="dropdown-item fs-14px"
                           onclick="delete_modal('{{route('admin.claim-listing.delete',[ 'id'=>$listings->id])}}')"
