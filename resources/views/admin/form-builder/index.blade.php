                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <form method="POST" action="" class="ol-card category-card radious-10px p-2 h-100">
                                        @csrf
                                        <div id="sortable-fields-{{ $type->slug }}">
                                            @php 
                                                $form_data = $grouped_forms[$type->slug] ?? []; 
                                            @endphp
                                                            ...
                                                            @case('email')
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="{{ $field['subtype'] ?? 'text' }}" 
                                                                           name="{{ $field['name'] }}" 
                                                                           class="ol-form-control {{ $field['className'] ?? 'form-control ol-form-control' }}" 
                                                                           placeholder="{{ $field['placeholder'] ?? '' }}" 
                                                                           {{ $field['required'] ? 'required' : '' }}>
                                                                    <div class="d-flex gap-1 eGap">
                                                                        <a href="javascript:void(0);" class="fs-14px text-danger"
                                                                           onclick="delete_modal('{{ route('form-builder.delete', ['type' => $type->slug, 'name' => urlencode($field['name'])]) }}')">
                                        ...
                                        @if (count($form_data))
                                            ...
                                            <div class="d-flex gap-3">
                                                <button type="button" class="btn ol-btn-primary mt-3" id="save-order-{{ $type->slug }}">
                                                    {{ get_phrase('Save Field Order') }}
                                                </button>
                                                <a href="{{ route('form-builder.edit', ['type' => $type->slug]) }}" class="btn ol-btn-primary mt-3">
                                                    {{ get_phrase('Edit') }}
                                                </a>
                                            </div>
                                        @else
