                ...
                <div>
                    ...
                    <div class="mb-30px">
                        <form method="POST" action="{{ route('register') }}">
                           ...
                           <div class="mb-4">
                                <label for="phone" class="form-label ua-form-label mb-3">{{ get_phrase('Phone') }}<span>*</span></label>
                                <input type="number" class="form-control ua-form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone') }}" placeholder="Your Phone" required autocomplete="phone">
                      ...
                      <div class="google_login mt-3">
                        <a href="{{ route('google.redirect') }}" class="btn google_login_tab"><img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="" style="height:18px;vertical-align:middle;margin-right:8px;">Continue with Google</a>
                      </div>
