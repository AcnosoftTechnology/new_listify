            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-lg-6">
                    <div>
                        ...
                        <a href="{{ route('google.redirect') }}" class="btn google_login_tab mb-2"><img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="" style="height:18px;vertical-align:middle;margin-right:8px;">Continue with Google</a>
                        <a href="{{ route('facebook.redirect') }}" class="btn google_login_tab">
