                                    ...
                                    <tr class="ca-tr">
                                     ...
                                     <td>
                                        <div class="sm2-banner-wrap">
                                            ...
                                            <img src="{{ get_all_image('listing-images/' . $firstImage) }}" alt="banner">
                                        </div>
                                      </td>

                                      <td class="ca-subtitle-14px ca-text-dark min-w-110px">
                                        <a href="{{route('listing.details',['type'=>$listing->type, 'id'=>$listing->id,'slug'=>slugify($listing->title)])}}">
                                            {{$listing->title}}
                                        </a>
                                        </td>
                                      ...
                                      <td class="ca-subtitle-14px ca-text-dark text-nowrap">
                                        {{($listing->price > 0) ? currency($listing->price):''}}
                                      </td>
                                                  ...
                                                  <ul class="dropdown-menu dropdown-menu-end at-dropdown-menu">
                                                      <li>
                                                          <a class="dropdown-item"
                                                             onclick="delete_modal('{{route('customer.remove.wishlist',['id'=>$wishlist->id])}}')"
                                                             href="javascript:void(0)">
                                                             {{get_phrase('Remove Wishlist')}}
                                                          </a>
                                                      </li>
                                                  </ul>
                                              </div>
