...
@push('title', get_phrase('Order Delivery'))
@push('meta')@endpush
            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <div class="d-flex align-items-start justify-content-between gap-2 mb-20px">
                    <div class="d-flex justify-content-between align-items-start gap-12px flex-column flex-lg-row w-100">
                        <h1 class="ca-title-18px">{{get_phrase('Delivered Orders')}}</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb cap-breadcrumb">
                                ...
                                <li class="breadcrumb-item cap-breadcrumb-item active" aria-current="page">{{get_phrase('Delivered Orders')}}</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="ca-content-card">
                    <div class="table-responsive pb-1">
                        <table class="table ca-table ca-table-width">
                            <thead class="ca-thead">
                              <tr class="ca-tr">
                                ...
                                <th scope="col" class="ca-title-14px ca-text-dark">{{get_phrase('Delivered At')}}</th>
                            ...
                            <tbody class="ca-tbody" style="vertical-align: inherit;">
                                @php $num = 1 @endphp
                                @foreach ($deliveryOrders as $key => $order)
                                @php
                        ...
                        <div class="mt-20px d-flex align-items-center gap-3 justify-content-between flex-wrap ePagination">
                            <p class="in-subtitle-12px">{{get_phrase('Showing').'  to '.count($deliveryOrders).' '.get_phrase('of').' '.count($deliveryOrders).' '.get_phrase('results')}} </p>
