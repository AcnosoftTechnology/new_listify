                ...
                <div class="col-lg-8 col-xl-9">
                    ...
                    <div class="ca-content-card">
                        ...
                        <div class="dl_column_form d-flex flex-column rg-22">
                           ...
                           <!-- whatsapp -->
                            <div class="row justify-content-between align-items-center mb-3 mb-3">
                                <label for="whatsapp"  class="col-sm-2 cap-form-label">{{ get_phrase('Whatsapp No') }}</label>
                                <div class="col-sm-10 col-md-9 col-lg-10">
                                    <input type="text" placeholder="+88 (00) 1234 56789" class="form-control cap-form-control" id="whatsapp" name="whatsapp" value="{{ $user->whatsapp }}"/>
                                </div>
                            </div>
                            <!-- Facebook -->
                            <div class="row justify-content-between align-items-center mb-3 mb-3">
