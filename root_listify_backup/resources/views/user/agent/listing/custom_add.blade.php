    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-basic-info" role="tabpanel" aria-labelledby="pills-basic-info-tab" tabindex="0">
            ...
            <div class="mb-2">
				...
				<div class="col-sm-6">
					<div class="mb-3">
						<label for="visibility" class="form-label cap-form-label"> {{get_phrase('Type')}} *</label>
...
@endphp
            ...
            <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2">
                        <div class="mt-2">
                            <a href="https://www.gps-coordinates.net/" target="_blank" class="btn btn-primary">{{get_phrase('Get lat & Long')}}</a>
                        </div>
                    </div>
                </div>
                <div class="mt-3">
        ...
        <div class="tab-pane fade" id="pills-address" role="tabpanel" aria-labelledby="pills-address-tab" tabindex="0">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="mb-2">
                        <label for="city" class="form-label cap-form-label"> {{get_phrase('State/City')}} *</label>
                        <select name="city" id="city" class="at-select2 cap-select2 select2-hidden-accessible" data-select2-id="select2-data-1-2ryci6" tabindex="-1" aria-hidden="true">
                            <option value=""> {{get_phrase('Select listing state/city')}} </option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-2">
                <label for="post_code" class="form-label cap-form-label"> {{get_phrase('Pincode')}} *</label>
                <input type="text" name="post_code" id="post_code" class="form-control cap-form-control" placeholder="{{get_phrase('Enter Pincode')}}" >
            </div>
        </div>
