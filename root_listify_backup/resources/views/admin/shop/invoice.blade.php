        ...
        <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse: collapse; border: 1px solid #ccc;">
                ...
                @foreach ($products as $product)
                    ...
                    @if($inventory)
                        <tr>
                            ...
                            <td style="border: 1px solid #ccc; text-align: right; font-family: 'DejaVu Sans', sans-serif;">&#8377;{{ number_format($unit_price, 2) }}</td>
                            <td style="border: 1px solid #ccc; text-align: center;">{{ $quantity }}</td>
                            <td style="border: 1px solid #ccc; text-align: right; font-family: 'DejaVu Sans', sans-serif;">&#8377;{{ number_format($total_price, 2) }}</td>
                        </tr>
                    @endif
                @endforeach
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td style="border: 1px solid #ccc; text-align: right; font-family: 'DejaVu Sans', sans-serif;">&#8377;{{ currency($invoice->amount) }}</td>
                </tr>
                <tr>
