                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                @foreach (json_decode($listing->image) as $key => $image)                            	
                                  <div class="possition_relative image-box" id="image-icon{{ $key }}">
                                    <img class="object-fit" src="{{ asset('uploads/listing-images/'.$image) }}" class="rounded" height="50" width="50">                           

                                    <a href="javascript:void(0);" 
                                       onclick="listing_image_delete('{{ route('admin.listing.image.delete', ['type' => $type, 'id' => $listing->id]) }}?image={{ $image }}', '{{ $key }}')">
...
function listing_image_delete(url, key) {
    ...
    .then(res => {
        ...
        if (res.status == 1) {
            ...
            let el = document.getElementById('image-icon' + key);
