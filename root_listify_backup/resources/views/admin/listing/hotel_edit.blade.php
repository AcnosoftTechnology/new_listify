                        ...
                        <div class="col-sm-10">
                            <div class="d-flex flex-wrap" id="image-container">
                                ...
                                <div class="possition_relative" id="image-icon{{$key}}">
                                   ...
                                   <a href="javascript:void(0);"onclick="listing_image_delete('{{ route('admin.listing.image.delete', ['type'=>$type, 'id'=>$listing->id]) }}?image={{ urlencode($image) }}', '{{ $key }}')">
                                    <i data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('delete') }}" class="fas fa-trash-alt"></i>
                                   </a>
