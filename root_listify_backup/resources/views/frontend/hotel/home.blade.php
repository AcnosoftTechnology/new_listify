        ...
        <div class="container">
            ...
            <div class="row g-4 mb-100px">
                ...
                @foreach (sort_listings_by_distance($top_listings->where('is_popular', 'top'), 4) as $listing)
                    ...
                    @endphp
                    <!-- Single Card -->
                    <div class="col-xl-3 col-md-6 col-sm-6" data-listing-id="{{ $listing->id }}" data-listing-type="hotel">
    ...
    <section>
        <div class="container">
            ...
            <div class="row g-4 mb-100px">
                @php
                @endphp
                @foreach (sort_listings_by_distance($top_listings->where('is_popular', 'popular'), 4) as $listing)
                    @php
                        $images = json_decode($listing->image) ?? [];
                    @endphp
                    <!-- Single Card -->
