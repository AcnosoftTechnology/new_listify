                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="hoteldetails-rent-area d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="hotelrent-price-area d-flex align-items-center flex-wrap">
                            <p class="price">{{ get_phrase('Total Price : ') }}<span class="sale_price">{{ currency($listing->price) }}</span></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row row-28 mb-80">
                ...
                @foreach (sort_listings_by_distance($relatedListing) as $listings)
                  ...
                  @endphp
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6" data-listing-id="{{ $listings->id }}" data-listing-type="hotel">
