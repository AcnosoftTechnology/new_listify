...
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="in-title-3 fw-semibold mt-30px mb-30px">
                        ...
                        <a href="{{ route('blog.details',['id'=>$blog->id, 'slug'=>slugify($blog->title)]) }}" class="mh-blog-link max-w-md-450px mx-auto">
                            ...
                            <div class="mh-blog-card">
                                ...
                                <div class="p-20px">
                                    ...
                                    <p class="at-category-badge mb-12px">
                                        {{ $category_name?->name ?? 'Uncategorized' }}
                                    </p>

                                    <div class="mh-blog-titles mb-2 pb-3">

                                        <h4 class="in-title-20px fw-semibold at-text-dark mb-12px">
                                            {{ $blog->title }}
                                        </h4>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-3 gap-3">
                                        ...
                                        <div class="d-flex align-items-center gap-10px">
                                            ...
                                            <div class="image-circle-40px">
                                                <img src="{{ get_all_image('users/' . ($usersBlog?->image ?? 'default.png')) }}" alt="">
                                            </div>

                                            <div>

                                                <h6 class="in-title-16px at-text-dark mb-2">
                                                    {{ $usersBlog?->name ?? 'Unknown User' }}
                                                </h6>

                                                <p class="in-subtitle-14px lh-1 fw-medium at-text-secondary">
