                ...
                @switch($field['type'])
                    ...
                    @case('email')
                        <div class="form-group">
                            ...
                            <input type="{{ $field['subtype'] ?? 'text' }}"  name="{{ $field['name'] }}" class="mform-control {{ $field['className'] ?? 'form-control mform-control' }}"   placeholder="{{ $field['placeholder'] ?? '' }}"  value="{{ $prefill }}" {{ $field['required'] ? 'required' : '' }}>
                    ...
                    @case('number')
                        <div class="form-group">
                            <label for="{{ $field['name'] }}" class="smform-label2">{{ $field['label'] }}</label>
                            <input type="number"  name="{{ $field['name'] }}" placeholder="{{ $field['placeholder'] ?? '' }}"  class="form-control mform-control {{ $field['className'] ?? 'form-control mform-control' }}" value="{{ $prefill }}" {{ $field['required'] ? 'required' : '' }}>
                    ...
                    @case('textarea')
                        <div class="form-group">
                            <label for="{{ $field['name'] }}" class="smform-label2">{{ $field['label'] }}</label>
                            <textarea name="{{ $field['name'] }}" placeholder="{{ $field['placeholder'] ?? '' }}" class="mform-control {{ $field['className'] ?? 'form-control mform-control' }}"  {{ $field['required'] ? 'required' : '' }}>{{ $prefill }}</textarea>
