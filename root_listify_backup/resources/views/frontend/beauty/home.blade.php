                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between bt-banner-area align-items-start">
                        ...
                        <div class="bt-banner-wrap">
                            ...
                            <a href="{{ $BeautyBanner->video_url ?? asset('image/placeholder.png') }}" class="d-none bt-banner-play-btn video-popup" data-maxwidth="900px" data-vbtype="{{ $BeautyBanner->video_url ? 'video' : '' }}">
        ...
        <div class="container">
            ...
            <div class="row g-4 mb-30px">
                @if (count($BeautyPopular) > 0)
                    @foreach (sort_listings_by_distance($BeautyPopular) as $popular)
                        @php
        ...
        <div class="container">
            ...
            <div class="row g-4 mb-30px">
                @if (count($BeautyBest) > 0)
                    @foreach (sort_listings_by_distance($BeautyBest) as $best)
                        @php
        ...
        <div class="container">
            ...
            <div class="row g-4 mb-30px">
                @if (count($BeautyWellness) > 0)
                    @foreach (sort_listings_by_distance($BeautyWellness) as $wellness)
                        @php
