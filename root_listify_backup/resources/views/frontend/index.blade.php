...
@section('frontend_layout')
                ...
                <div class="col-12">
                    <div class="atn-search-filter-wrap">
                        <ul class="nav nav-pills atn-search-nav-pills" id="pills-tab" role="tablist">
                            @php
                                $types = \App\Models\CustomType::where('status', 1)->where('featured', '1')->take(5)->get();                               
    ...
    <section>
        <div class="container">
            <div class="row mb-30px">
                <div class="col-12">
                    <h1 class="in-title-36px text-center text-capitalize lh-1">{{ get_phrase('Browse Top Categories , Featured Listings') }}</h1>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row mb-30px">
                <div class="col-12">
                    ...
                    <div class="d-flex gap-14px justify-content-center flex-wrap home_page_listingtab">
            ...
            <div class="mixitup2 row g-4 mb-30px" id="featured-listings-container">
                <!-- Hotel  Single Card -->
                @foreach ($Totalhotels as $hotelList)
                    ...
                    @endphp
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mix hotel" data-listing-id="{{ $hotelList->id }}" data-listing-type="hotel">
                        <div class="single-grid-card">
                            ...
                            <div class="hotel-grid-details position-relative">
                                ...
                                <div class="hotelgrid-location-rating d-flex align-items-center justify-content-between flex-wrap">
                                    <div class="location d-flex align-items-center flex-wrap gap-1">
                                        <img src="{{ asset('assets/frontend/images/icons/location-purple-16.svg') }}" alt="">
                                        <p class="name">{{ $cityName->name }}, {{ $countryName->name }}</p>
                                        @include('frontend.partials.listing_distance', ['listing' => $hotelList])
                                    </div>
                                    @php
                ...
                @foreach ($Totalrestaurant as $restaurantList)
                    ...
                    @endphp
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mix restaurant" data-listing-id="{{ $restaurantList->id }}" data-listing-type="restaurant">
                        <div class="single-grid-card">
                            <!-- Banner Slider -->
                            <div class="grid-slider-area">
                                ...
                                <div class="restaurent-grid-details">
                                    ...
                                    <div class="restgrid-price-rating d-flex align-items-center justify-content-between">
                                        <div class="location d-flex align-items-center flex-wrap gap-1">
                                            ...
                                            @include('frontend.partials.listing_distance', ['listing' => $restaurantList])
                                        </div>
                                        <div class="ratings d-flex align-items-center">
                ...
                @foreach ($Totalbeauty as $beautyList)
                    ...
                    @endphp
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mix beauty" data-listing-id="{{ $beautyList->id }}" data-listing-type="beauty">
                        <div class="single-grid-card">
                            <!-- Banner Slider -->
                            <div class="grid-slider-area">
                            ...
                            <div class="beauty-grid-details position-relative">
                                <div class="beautygrid-location-title">
                                    <div class="location d-flex align-items-center flex-wrap gap-1">
                                        ...
                                        @include('frontend.partials.listing_distance', ['listing' => $beautyList])
                                    </div>
                ...
                @foreach ($TotalrealEstate as $realEsate)
                    ...
                    @endphp
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mix real-estate" data-listing-id="{{ $realEsate->id }}" data-listing-type="real-estate">
                        <div class="single-grid-card">
                            <!-- Banner Slider -->
                            <div class="grid-slider-area">
                            ...
                            <div class="reals-grid-details position-relative">
                                <div class="location d-flex align-items-center flex-wrap gap-1">
                                    ...
                                    @include('frontend.partials.listing_distance', ['listing' => $realEsate])
                                </div>
                ...
                @foreach ($Totalcar as $carList)
                    ...
                    @endphp
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mix car" data-listing-id="{{ $carList->id }}" data-listing-type="car">
                        <div class="single-grid-card nCar">
                            ...
                            <div class="car-grid-details position-relative">
                                <div class="cargrid-title-area">
                                    ...
                                    @include('frontend.partials.listing_distance', ['listing' => $carList])
                                </div>
                                <ul class="cargrid-list-items d-flex align-items-center flex-wrap">
                                    <li>
                                        ...
                                        <p class="info">{{ optional($engineSize)->name ?? 'N/A' }}</p>
                                    ...
                                    <li>
                                        ...
                                        <p class="info">{{ optional($fuelType)->name ?? 'N/A' }}</p>
                                    </li>
                                </ul>
            ...
            @foreach($groupedListings as $type => $listingsByType)
                @foreach($listingsByType->take(8) as $listing)
                     @php
                       $dynamicImage = json_decode($listing->image, true) ?? [];
    $image = !empty($dynamicImage[0]) ? $dynamicImage[0] : 'default.png';
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 mix {{ $listing->type }}" data-listing-id="{{ $listing->id }}" data-listing-type="{{ $listing->type }}">
                         <div class="single-grid-card">
                            <!-- Banner Slider -->
                            <div class="grid-slider-area">
     ...
     src="{{ !empty($image) ? get_all_image('listing-images/' . $image) : asset('assets/images/default.png') }}"
     alt="Hotel Image">
                                </a>
                                @php
                            ...
                            <div class="hotel-grid-details position-relative">
                                ...
                                <div class="hotelgrid-location-rating d-flex align-items-center justify-content-between flex-wrap">
                                    <div class="location d-flex align-items-center flex-wrap gap-1">
                                        <img src="{{ asset('assets/frontend/images/icons/location-purple-16.svg') }}" alt="">
                                        <p class="name">{{ $cityName->name }}, {{ $countryName->name }}</p>
                                        @include('frontend.partials.listing_distance', ['listing' => $listing])
                                    </div>
                                    @php
    ...
    <section class="mt-5 pt-4 d-none">
        <div class="container">
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="in-title-36px text-center text-capitalize">{{ get_phrase('What people Think About Us') }}</h1>
                </div>
            </div>
        </div>
        <div class="mb-100px">
            ...
            <div class="row mb-100px g-4">
                @if (count($blogs) > 0)
                    @foreach ($blogs as $blog)
                       @php
                        $category_name = App\Models\Blog_category::find($blog->category);
    $usersBlog = App\Models\User::find($blog->user_id);
@endphp
    ...
    <img src="{{ get_all_image('blog-images/' . ($blog->image ?? 'default-blog.jpg')) }}" alt="{{ $blog->title }}">
</div>
                                    <div class="p-20px">
                                        <p class="at-category-badge mb-12px">{{ optional($category_name)->name ?? '' }}</p>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-3 gap-3">
                                            <div class="d-flex align-items-center gap-10px">
                                                ...
                                                <div>
                                                    <h6 class="in-title-16px at-text-dark mb-2">{{ optional($usersBlog)->name ?? 'Admin' }}</h6>
...
<!-- Scroll btn -->
<div class="scroll-icon-area custom-scroll-area">
    <a href="javascript:;" class="instant-scroll-btn">
...
<script>
    $(document).ready(function () {
        ...
        $('.instant-scroll-btn').on('click', function (e) {
            e.preventDefault();
