...
use App\Http\Controllers\Frontend\PhonePePaymentController;
...
//Route::get('/pay', [PhonePeController::class, 'showPayForm'])->name('phonepe.form');
//Route::post('/phonepe/pay', [PhonePeController::class, 'initiate'])->name('phonepe.initiate');
//Route::get('/phonepe/redirect', [PhonePeController::class, 'redirectHandler'])->name('phonepe.redirect');

// PhonePe webhook/callback (POST)
...
//Route::get('/phonepe/refund-status/{merchantRefundId}', [PhonePeController::class, 'refundStatus'])->name('phonepe.refundStatus');


//Route::get('/pay', [PhonePePaymentController::class, 'showPaymentForm'])->name('phonepe.form');

// Payment initiate form submit
//Route::post('/phonepe/initiate', [PhonePePaymentController::class, 'initiatePayment'])->name('phonepe.initiate');

// Payment callback
//Route::get('/phonepe/callback', [PhonePePaymentController::class, 'handleCallback'])->name('phonepe.callback');
...
Route::post('newsletter/subscribe', [FrontendController::class, 'newslater_subscribe'])->name('newsletter.subscribe');
 ...
 Route::prefix('{prefix}')->middleware(['auth', 'anyAuth'])->group(function () {
    ...
    Route::get('/{type}/all-listings', [DashboardController::class, 'allListings'])->name('admin.all.listings');  
    ...
    Route::get('/notifications/create', [NotificationController::class, 'create'])->name('admin.notification.create');
    ...
    Route::post('/notifications/update/{id}', [NotificationController::class, 'update'])->name('admin.notification.update');
    Route::delete('/admin/notifications/delete/{id}', [NotificationController::class, 'destroy'])->name('admin.notification.destroy');
    ...
    Route::get('/customlisting-setting', [SettingController::class, 'Customlisting_setting'])->name('admin.Customlisting.settings');
    Route::get('/customlisting-setting/add', [SettingController::class, 'addcustomlisting'])->name('admin.Customlisting_settings.add');  
    Route::post('/customlisting-setting/store-customlisting', [SettingController::class, 'storecustomlisting'])->name('admin.customer.storecustomlisting');  
    Route::get('/customlisting-setting/edit/{id}', [SettingController::class, 'editcustomlisting'])->name('admin.Customlisting_settings.edit');  
    Route::post('/customlisting-setting/update-customlisting/{id}', [SettingController::class, 'updatecustomlisting'])->name('admin.customer.updatecustomlisting');
    Route::delete('/customlisting-setting/delete/{id}', [SettingController::class, 'destroy'])->name('admin.Customlisting_settings.destroy');
    ...
    Route::get('/listing-image-delete/{type}/{id}', [ListingController::class, 'listing_image_delete'])->name('admin.listing.image.delete');
...
Route::fallback([FrontendController::class, 'custom_listing']);


// Geolocation API Routes
Route::prefix('api')->group(function () {
    Route::post('/location/address', [LocationController::class, 'getUserAddress']);
    Route::post('/location/geocode', [LocationController::class, 'geocodeAddress']);
    Route::post('/location/store', [LocationController::class, 'storeUserLocation']);
    Route::post('/location/nearby', [LocationController::class, 'getNearbyListings']);
    Route::post('/location/sorted-featured', [LocationController::class, 'getSortedFeaturedListings']);
});
