...
Route::get('/auth/facebook/redirect', [RegisteredUserController::class, 'facebookRedirect'])->name('facebook.redirect');
Route::get('/auth/facebook/callback', [RegisteredUserController::class, 'facebookCallback'])->name('facebook.callback');
